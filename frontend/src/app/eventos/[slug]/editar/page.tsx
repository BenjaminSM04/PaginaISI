...
function EditarEventoContent() {
  ...
  return (
    <div className="container max-w-3xl space-y-8 py-10">
      ...
      {error && <p role="alert" className="rounded-xl border border-danger/30 bg-danger/10 p-4 text-sm text-danger">{error instanceof Error ? error.message : 'No se pudo cargar el evento'}</p>}
